//
//  NSObject+ValueCoding.m
//  KVC
//
//  Created by Tian on 2021/5/7.
//

#import "NSObject+ValueCoding.h"
#import <objc/runtime.h>

@implementation NSObject (ValueCoding)
...
- (void)zy_setValue:(nullable id)value forKey:(NSString *)key {
    ...
    if (![self.class accessInstanceVariablesDirectly]) {
        if (undefinedIMP) {
            [self zy_performSelectorWithMethodName:undefinedMethodName value:value key:key];
        } else {
...
#pragma mark - 相关方法
- (BOOL)zy_performSelectorWithMethodName:(NSString *)methodName value:(id)value key:(id)key {
